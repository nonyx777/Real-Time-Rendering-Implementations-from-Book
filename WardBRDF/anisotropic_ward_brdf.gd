...
@export var roughness_1: float
@export var roughness_2: float
...
func _ready() -> void:
	...
	material1.set_shader_parameter("roughness_1", roughness_1)
	material1.set_shader_parameter("roughness_2", roughness_2)
	...
	material2.set_shader_parameter("roughness_1", roughness_1)
	material2.set_shader_parameter("roughness_2", roughness_2)
